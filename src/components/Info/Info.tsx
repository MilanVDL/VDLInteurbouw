        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
              ...
              <figure className="relative isolate">
                ...
                <blockquote className="mt-6 text-xl font-semibold leading-8 text-white">
                  <p>
                    “Na het kopen van het nieuwe pand voor mijn bedrijf zag het
                    er nog al leeg uit, Youri heeft ons enorm geholpen met het
                    op maat maken van het intereur wat heeft geleid tot een
                    professionele werk omgeving. Had geen beteren service kunnen
                    verwachten.”
                  </p>
                </blockquote>
          ...
          <div>
            ...
            <div className="mt-10 flex">
              ...
              >
                Lees meer over ons <span aria-hidden="true">&rarr;</span>
              </a>
            </div>
          </div>
        </div>
